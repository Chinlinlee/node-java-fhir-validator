...
/**
 * This class just defines types, you should import {@link ICreateWithQuery} instead of this.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export declare class ICreateWithQueryClass extends JavaClass {
    /**
 ...
 * you should use {@link createICreateWithQueryProxy} for actually creating the proxies.
 *
 ...
 * You should probably not edit this.
 */
export interface ICreateWithQueryInterface {
    /**
     * @param var0 original type: 'ca.uhn.fhir.rest.gclient.ICriterion'
     * @return original return type: 'ca.uhn.fhir.rest.gclient.IBaseQuery'
     */
 ...
 * @return the proxy
 */
export declare function createICreateWithQueryProxy(methods: ICreateWithQueryInterface, opts?: InterfaceProxyOptions): JavaInterfaceProxy<ICreateWithQueryInterface>;
declare const ICreateWithQuery_base: typeof ICreateWithQueryClass;
/**
 ...
 * You should probably not edit this.
 */
export declare class ICreateWithQuery extends ICreateWithQuery_base {
    /**
...
export default ICreateWithQuery;
//# sourceMappingURL=ICreateWithQuery.d.ts.map