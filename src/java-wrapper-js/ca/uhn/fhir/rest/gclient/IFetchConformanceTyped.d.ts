...
/**
 * This class just defines types, you should import {@link IFetchConformanceTyped} instead of this.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export declare class IFetchConformanceTypedClass extends JavaClass {
    /**
 ...
 * you should use {@link createIFetchConformanceTypedProxy} for actually creating the proxies.
 *
 ...
 * You should probably not edit this.
 */
export interface IFetchConformanceTypedInterface {
    /**
     * @return original return type: 'java.lang.Object'
     */
...
/**
 * Create a proxy for the {@link IFetchConformanceTyped} interface.
 * All required methods in {@link IFetchConformanceTypedInterface} must be implemented.
 *
 * @param methods the methods to implement
 * @param opts the proxy options
 * @return the proxy
 */
export declare function createIFetchConformanceTypedProxy(methods: IFetchConformanceTypedInterface, opts?: InterfaceProxyOptions): JavaInterfaceProxy<IFetchConformanceTypedInterface>;
declare const IFetchConformanceTyped_base: typeof IFetchConformanceTypedClass;
/**
 * Class ca.uhn.fhir.rest.gclient.IFetchConformanceTyped.
 *
 * This actually imports the java class for further use.
 * The class {@link IFetchConformanceTypedClass} only defines types, this is the class you should actually import.
 * Please note that this statement imports the underlying java class at runtime, which may take a while.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export declare class IFetchConformanceTyped extends IFetchConformanceTyped_base {
    /**
...
export default IFetchConformanceTyped;
//# sourceMappingURL=IFetchConformanceTyped.d.ts.map