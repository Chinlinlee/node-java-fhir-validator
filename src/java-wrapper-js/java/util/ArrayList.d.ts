...
/**
 * This class just defines types, you should import {@link ArrayList} instead of this.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export declare class ArrayListClass extends JavaClass {
    /**
     ...
     */
    static newInstanceAsync(var0: java_util_Collection | JavaInterfaceProxy<java_util_CollectionInterface> | null): Promise<ArrayList>;
    /**
     * @return original return type: 'java.util.ArrayList'
     */
    static newInstanceAsync(): Promise<ArrayList>;
    /**
     * @param var0 original type: 'int'
     * @return original return type: 'java.util.ArrayList'
     */
    static newInstanceAsync(var0: java_lang_Integer | number): Promise<ArrayList>;
    /**
     * @param var0 original type: 'java.util.Collection'
     */
...
declare const ArrayList_base: typeof ArrayListClass;
/**
 * Class java.util.ArrayList.
 *
 * This actually imports the java class for further use.
 * The class {@link ArrayListClass} only defines types, this is the class you should actually import.
 * Please note that this statement imports the underlying java class at runtime, which may take a while.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export declare class ArrayList extends ArrayList_base {
}
