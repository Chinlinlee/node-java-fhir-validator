...
/**
 * This class just defines types, you should import {@link EntityReference} instead of this.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export declare class EntityReferenceClass extends JavaClass {
    /**
     * Original type: 'short'
     */
 ...
 * you should use {@link createEntityReferenceProxy} for actually creating the proxies.
 *
 ...
 * You should probably not edit this.
 */
export interface EntityReferenceInterface {
    /**
     * @return original return type: 'void'
     */
    normalize(): void;
 ...
 * All required methods in {@link EntityReferenceInterface} must be implemented.
 *
 * @param methods the methods to implement
 * @param opts the proxy options
 * @return the proxy
 */
export declare function createEntityReferenceProxy(methods: EntityReferenceInterface, opts?: InterfaceProxyOptions): JavaInterfaceProxy<EntityReferenceInterface>;
declare const EntityReference_base: typeof EntityReferenceClass;
/**
 * Class org.w3c.dom.EntityReference.
 *
 * This actually imports the java class for further use.
 * The class {@link EntityReferenceClass} only defines types, this is the class you should actually import.
 * Please note that this statement imports the underlying java class at runtime, which may take a while.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export declare class EntityReference extends EntityReference_base {
    /**
