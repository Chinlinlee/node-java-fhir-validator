...
function createJsonCreatorProxy(methods, opts) {
    return (0, java_bridge_1.newProxy)('org.hl7.fhir.r4.formats.JsonCreator', methods, opts);
}
exports.createJsonCreatorProxy = createJsonCreatorProxy;
/**
 * Class org.hl7.fhir.r4.formats.JsonCreator.
 *
 ...
 */
class JsonCreator extends (0, java_bridge_1.importClass)('org.hl7.fhir.r4.formats.JsonCreator') {
    /**
