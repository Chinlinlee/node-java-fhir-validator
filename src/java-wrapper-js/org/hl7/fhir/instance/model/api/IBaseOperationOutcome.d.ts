...
/**
 * This class just defines types, you should import {@link IBaseOperationOutcome} instead of this.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export declare class IBaseOperationOutcomeClass extends JavaClass {
    /**
 ...
 * you should use {@link createIBaseOperationOutcomeProxy} for actually creating the proxies.
 *
 ...
 * You should probably not edit this.
 */
export interface IBaseOperationOutcomeInterface {
    /**
     * @return original return type: 'ca.uhn.fhir.context.FhirVersionEnum'
     */
 ...
 * @return the proxy
 */
export declare function createIBaseOperationOutcomeProxy(methods: IBaseOperationOutcomeInterface, opts?: InterfaceProxyOptions): JavaInterfaceProxy<IBaseOperationOutcomeInterface>;
declare const IBaseOperationOutcome_base: typeof IBaseOperationOutcomeClass;
/**
 ...
 * You should probably not edit this.
 */
export declare class IBaseOperationOutcome extends IBaseOperationOutcome_base {
    /**
...
export default IBaseOperationOutcome;
//# sourceMappingURL=IBaseOperationOutcome.d.ts.map